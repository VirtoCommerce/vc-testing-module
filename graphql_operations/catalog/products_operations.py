...
from graphql_operations.catalog.fragments.configuration_section_fragment import CONFIGURATION_SECTION_FRAGMENT
from graphql_operations.catalog.fragments.product_fragment import PRODUCT_FRAGMENT
