...
class Query(BaseModel):
    def __init__(self):
        ...
        self.pageContext: PageContextResponseType | None
        ...
        self.loyaltyPointsHistory: LoyaltyOperationLogConnection | None
        self.loyaltyBalance: LoyaltyBalanceResult | None
