...
class OpusUserType(BaseModel):
    def __init__(self):
        from graphql_client.types.industry_sector import IndustrySector
        from datetime import datetime
        from graphql_client.types.role_type import RoleType
        from graphql_client.types.opus_user_type import OpusUserType
        ...
        self.contact: OpusContactType | None
        self.lockedState: bool | None
        self.operator: OpusUserType | None
        self.temporaryPassword: bool
        self.industrySector: IndustrySector
        self.canBypassTermsAndConditionsSection1: bool
        self.canBypassTermsAndConditionsSection2: bool
