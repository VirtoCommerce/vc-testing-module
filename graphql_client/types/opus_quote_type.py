...
class OpusQuoteType(BaseModel):
    def __init__(self):
        ...
        from graphql_client.types.opus_quote_item_type import OpusQuoteItemType
        ...
        from graphql_client.types.quote_referral_info_type import QuoteReferralInfoType
        ...
        self.items: list[OpusQuoteItemType]
        ...
        self.phone: str | None
        self.email: str
        self.parentNumber: str | None
        self.referralInfo: QuoteReferralInfoType | None
