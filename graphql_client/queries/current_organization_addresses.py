...
class CurrentOrganizationAddressesQuery:
    ...
    def execute(self, variables: dict, return_fields: str = None) -> MemberAddressConnection:
        ...
        return self.graphql_client.execute(gql(query_string), variables)["currentOrganizationAddresses"]
