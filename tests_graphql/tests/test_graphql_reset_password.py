...
from graphql_client.mutations.reset_password_by_token import (
...
def test_reset_password(
    ...
    assert (
        reset_password_result["succeeded"] is True
    ), f"Password reset failed: {reset_password_result['errors'][0]['description']}"
