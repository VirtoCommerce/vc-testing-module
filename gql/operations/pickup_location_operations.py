...
class PickupLocationOperations(BaseOperations):
    def get_pickup_locations(
        ...
        return [PickupLocation.model_validate(item) for item in result["data"]["pickupLocations"]["items"]]
    ...
    def get_product_pickup_locations(
        ...
        return [
            ProductPickupLocation.model_validate(item) for item in result["data"]["productPickupLocations"]["items"]
        ]
    ...
    def get_cart_pickup_locations(
        ...
        return [ProductPickupLocation.model_validate(item) for item in result["data"]["cartPickupLocations"]["items"]]
