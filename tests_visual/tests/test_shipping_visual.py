...
def test_visual_shipping(
    ...
    # Navigate through cart to shipping (can't access shipping page directly) due to the way checkout is implemented
    cart.navigate()
    ...
    image_snapshot(image, "tests_visual/pages/shipping/shipping_snapshots/shipping_base.png", True)
