...
def test_e2e_switch_category_grid_view(config: dict, page: Page, anonymous_catalog_requests: AnonymousCatalogRequests):
...
def test_e2e_switch_category_list_view(config: dict, page: Page, anonymous_catalog_requests: AnonymousCatalogRequests):
