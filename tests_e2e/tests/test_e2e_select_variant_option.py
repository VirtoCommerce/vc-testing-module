...
def test_e2e_select_variant_option(
    ...
    print(f"{os.linesep}Running E2E test: Select variant option on Sport Band product page...", end=" ")
...
def test_e2e_variant_title_and_price_change(
    ...
    print(f"{os.linesep}Running E2E test: Variant title and price change on Sport Band...", end=" ")
    ...
    # --- Select first combination: Starlight + 42mm + S/M ---
    ...
    # --- Verify title and price for first combination ---
    ...
    # --- Switch color to Midnight Black (keep Size and WristSize) ---
    assert variation_selector.select_option(color_prop["name"], second_color)
    page.wait_for_load_state("networkidle")

    # --- Verify title and price changed for second combination ---
...
def test_e2e_add_variant_combinations_to_cart(
    ...
    print(f"{os.linesep}Running E2E test: Add 3 variant combinations to cart...", end=" ")
    ...
    # Combination 8: Light Blush + 45mm + S/M
    # Combination 14: Purple Fog + 42mm + S/M
    # Combination 17: Neon Yellow + 49mm + M/L
    combinations = [
        {
