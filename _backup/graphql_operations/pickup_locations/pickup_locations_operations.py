...
from graphql_operations.pickup_locations.fragments.product_pickup_locations_fragment import (
...
class PickupLocationsOperations:
    ...
    def get_pickup_locations(
        ...
        result = pickup_locations_query.execute(variables=variables, return_fields=PICKUP_LOCATION_FRAGMENT)
    ...
    def get_cart_pickup_locations(
        ...
        result = cart_pickup_locations_query.execute(variables=variables, return_fields=CART_PICKUP_LOCATION_FRAGMENT)
