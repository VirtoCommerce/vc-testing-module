...
def test_add_cart_coupon(config: Config, dataset: dict[str, Any], graphql_client: GraphQLClient):
    ...
    assert cart_with_coupon["discountTotal"]["amount"] > 0, "Discount total is not greater than 0"
