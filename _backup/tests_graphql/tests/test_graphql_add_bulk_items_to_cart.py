...
def test_add_bulk_items_to_anonymous_cart(config: Config, dataset: dict[str, Any], graphql_client: GraphQLClient):
    ...
    product_sku_in_stock_1 = "product-acme-laptop-asus-zenbook-a14-ux3407"
    product_sku_in_stock_2 = "product-acme-laptop-asus-vivobook-16-x1607qa"
