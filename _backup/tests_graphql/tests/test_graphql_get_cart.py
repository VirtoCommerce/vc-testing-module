...
def test_get_null_cart(config: Config, dataset: dict[str, Any], graphql_client: GraphQLClient):
...
def test_get_anonymous_cart(config: Config, dataset: dict[str, Any], graphql_client: GraphQLClient):
