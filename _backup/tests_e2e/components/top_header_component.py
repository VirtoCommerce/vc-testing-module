...
class TopHeaderComponent:
    ...
    def language_selector_component(self) -> LanguageSelectorComponent:
        return LanguageSelectorComponent(
            self.element.locator("[data-test-id='main-layout.top-header.language-selector']")
        )

    @property
    def currency_selector_component(self) -> CurrencySelectorComponent:
        return CurrencySelectorComponent(
            self.element.locator("[data-test-id='main-layout.top-header.currency-selector']")
        )
    ...
    def account_menu_component(self) -> AccountMenuComponent:
        return AccountMenuComponent(self.element.locator("[data-test-id='main-layout.top-header.account-menu']"))
    ...
    def ship_to_selector(self) -> ShipToSelectorComponent:
        return ShipToSelectorComponent(self.element.locator("[data-test-id='ship-to-selector']"))

    @property
    def organization_name_label(self) -> Locator:
        return self.element.locator(f"[data-test-id='main-layout.top-header.organization-name-label']")
