...
def test_e2e_add_shipment_address_in_header_for_anonymous_user(
    ...
    expect(home_page.top_header_component.ship_to_selector.element).not_to_be_visible(), "Ship to selector is visible"
    expect(
    ...
    expect(home_page.top_header_component.ship_to_selector.element).to_be_visible(), "Ship to selector is not visible"
    expect(
