...
class WebAPISession(requests.Session):
    ...
    def get(self, endpoint: str, params: dict[str, Any] | None = None, **kwargs) -> Union[dict, str, bytes]:
        return self.send_request("GET", endpoint, params=params, **kwargs)

    def post(self, endpoint: str, data: dict[str, Any] | None = None, **kwargs) -> Union[dict, str, bytes]:
        return self.send_request("POST", endpoint, data=json.dumps(data), **kwargs)

    def put(self, endpoint: str, data: dict[str, Any] | None = None, **kwargs) -> Union[dict, str, bytes]:
    ...
    def patch(self, endpoint: str, data: dict[str, Any] | None = None, **kwargs) -> Union[dict, str, bytes]:
        headers = kwargs.pop("headers", {})
        # JSON Patch requires a distinct media type on .NET APIs.
        headers.setdefault("Content-Type", "application/json-patch+json")
        return self.send_request("PATCH", endpoint, data=json.dumps(data), headers=headers, **kwargs)
