...
def test_category_seo(graphql_client: GraphQLClient, ctx: Context) -> None:
    ...
    with allure.step(f"Verify entity info has semantic URL '{_CATEGORY_SLUG}'"):
