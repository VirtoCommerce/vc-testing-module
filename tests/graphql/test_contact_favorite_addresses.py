...
def test_contact_favorite_addresses(ctx: Context, graphql_client: GraphQLClient) -> None:
    ...
    try:
        ...
        address = next(a for a in contact_addresses if addresses_equal(a=a, b=TEST_ADDRESS))
        ...
        if address is not None:
            contact_ops.delete_member_addresses(member_id=ctx.contact_id, addresses=[address])
