...
def test_checkout_shipping_option_switch_single_page(global_settings: GlobalSettings, page: Page) -> None:
...
def test_checkout_shipping_option_switch_multi_step(global_settings: GlobalSettings, page: Page) -> None:
    cart_page = CartPage(global_settings=global_settings, page=page)
