...
from page_objects.frontend.pages import CartPage, CheckoutShippingPage
...
def test_checkout_filter_shipping_address_by_country_single_page(global_settings: GlobalSettings, page: Page) -> None:
    cart_page = CartPage(global_settings=global_settings, page=page)
...
def test_checkout_filter_shipping_address_by_region_single_page(global_settings: GlobalSettings, page: Page) -> None:
    cart_page = CartPage(global_settings=global_settings, page=page)
...
def test_checkout_filter_shipping_address_by_city_single_page(global_settings: GlobalSettings, page: Page) -> None:
    cart_page = CartPage(global_settings=global_settings, page=page)
...
def test_checkout_filter_shipping_address_by_country_multi_step(global_settings: GlobalSettings, page: Page) -> None:
    cart_page = CartPage(global_settings=global_settings, page=page)
...
def test_checkout_filter_shipping_address_by_region_multi_step(global_settings: GlobalSettings, page: Page) -> None:
    cart_page = CartPage(global_settings=global_settings, page=page)
...
def test_checkout_filter_shipping_address_by_city_multi_step(global_settings: GlobalSettings, page: Page) -> None:
    cart_page = CartPage(global_settings=global_settings, page=page)
