...
from page_objects.frontend.components import RemoveShoppingListItemModal
from page_objects.frontend.pages import AccountSavedForLaterPage, CartPage
...
@allure.feature("Cart / Save for later (E2E)")
@allure.title("Move a cart line item to the saved-for-later list and remove it")
