...
from page_objects.frontend.components import EditAddressModal, SelectAddressModal
from page_objects.frontend.pages import CartPage, CheckoutPaymentPage, CheckoutShippingPage
...
def test_checkout_billing_address_single_page(global_settings: GlobalSettings, page: Page) -> None:
    ...
    with allure.step("Verify billing address mirrors shipping address"):
        ...
        expect(cart_page.payment_details_section.billing_address_equals_shipping_checkbox).to_be_visible()
        expect(cart_page.payment_details_section.selected_address_label).to_be_visible()
        expect(cart_page.payment_details_section.selected_address_label).to_contain_text(str(TEST_CART_ADDRESS.line1))
...
def test_checkout_billing_address_multi_step(global_settings: GlobalSettings, page: Page) -> None:
    cart_page = CartPage(global_settings=global_settings, page=page)
...
def test_checkout_filter_billing_address_by_country_single_page(global_settings: GlobalSettings, page: Page) -> None:
    cart_page = CartPage(global_settings=global_settings, page=page)
    ...
    with allure.step("Navigate to the cart page and pick a saved shipping address"):
        ...
        cart_page.shipping_details_section.shipping_switcher.click()
        cart_page.shipping_details_section.shipping_address_section.select_address_button.click()
        shipping_modal = SelectAddressModal(root=page.locator("[data-test-id='select-address-modal']"))
    ...
    with allure.step("Open a separate billing address selection"):
        ...
        billing_modal = SelectAddressModal(root=page.locator("[data-test-id='select-address-modal']"))
...
def test_checkout_filter_billing_address_by_region_single_page(global_settings: GlobalSettings, page: Page) -> None:
    cart_page = CartPage(global_settings=global_settings, page=page)
...
def test_checkout_filter_billing_address_by_city_single_page(global_settings: GlobalSettings, page: Page) -> None:
    cart_page = CartPage(global_settings=global_settings, page=page)
...
def test_checkout_filter_billing_address_by_country_multi_step(global_settings: GlobalSettings, page: Page) -> None:
    cart_page = CartPage(global_settings=global_settings, page=page)
...
def test_checkout_filter_billing_address_by_region_multi_step(global_settings: GlobalSettings, page: Page) -> None:
    cart_page = CartPage(global_settings=global_settings, page=page)
...
def test_checkout_filter_billing_address_by_city_multi_step(global_settings: GlobalSettings, page: Page) -> None:
    cart_page = CartPage(global_settings=global_settings, page=page)
