"""Generate separate test coverage report PNG charts for Sprint 26-03."""
...
dates = ["Dec 23\n2025", "Jan 22\n2026", "Feb 6\n2026", "Feb 20\n2026"]
total_tests = [121, 161, 178, 183]
active_tests = [118, 151, 173, 178]

# === Current State ===
e2e_current = {"files": 30, "functions": 68, "active": 65, "ignored": 3}
gql_current = {"files": 60, "functions": 115, "active": 113, "ignored": 2}
total_current = {"files": 90, "functions": 183, "active": 178, "ignored": 5, "active_rate": 97.3}

# === Previous State (Sprint 26-02) ===
e2e_prev = {"files": 29, "functions": 65, "active": 62, "ignored": 3}
gql_prev = {"files": 58, "functions": 113, "active": 111, "ignored": 2}
total_prev = {"files": 87, "functions": 178, "active": 173, "ignored": 5, "active_rate": 97.2}


print("=" * 60)
print("  Generating Sprint 26-03 Charts")
print("  Report Date: February 20, 2026")
print("=" * 60)
...
ax.set_title("Test Growth Trend \u2014 Sprint 26-03", fontsize=20, fontweight="bold", pad=16, color=C_TEXT)
...
bars1 = ax.barh(
    y_pos + bar_h / 2, vals_p1, bar_h, label="Sprint 26-02", color=C_ACCENT2, edgecolor=C_BG, linewidth=1.5, alpha=0.6
)
bars2 = ax.barh(
    y_pos - bar_h / 2, vals_p2, bar_h, label="Sprint 26-03", color=bar_colors_p2, edgecolor=C_BG, linewidth=1.5
)
...
ax.set_title("Period Comparison Overview \u2014 Sprint 26-03", fontsize=20, fontweight="bold", pad=16, color=C_TEXT)
...
categories = ["Sprint 26-02\n(Period 1)", "Sprint 26-03\n(Period 2)"]
...
ax.set_ylabel("Number of Tests", fontsize=14, color=C_TEXT)
ax.set_title("Active vs Ignored Tests \u2014 Sprint 26-03", fontsize=20, fontweight="bold", pad=16, color=C_TEXT)
...
ax.text(0, 0.06, "183", ha="center", va="center", fontsize=40, fontweight="bold", color=C_TEXT)
ax.text(0, -0.12, "Total", ha="center", va="center", fontsize=16, color=C_GRAY)
ax.set_title("Test Distribution by Type \u2014 Sprint 26-03", fontsize=20, fontweight="bold", pad=20, color=C_TEXT)
...
w5 = 0.35
ax.bar(x5 - w5 / 2, e2e_p1, w5, label="Sprint 26-02", color=C_ACCENT2, edgecolor=C_BG, alpha=0.7)
ax.bar(x5 + w5 / 2, e2e_p2, w5, label="Sprint 26-03", color=C_SECONDARY, edgecolor=C_BG)
...
ax.bar(x6 - w5 / 2, gql_p1, w5, label="Sprint 26-02", color=C_ACCENT2, edgecolor=C_BG, alpha=0.7)
ax.bar(x6 + w5 / 2, gql_p2, w5, label="Sprint 26-03", color=C_ACCENT1, edgecolor=C_BG)
...
achievements = [
    ("New Tests", "+5", C_ACCENT1),
    ("New Files", "+3", C_GREEN),
    ("Active Rate", "97.3%", C_ACCENT2),
    ("Code Reduced", "-490 lines", C_SECONDARY),
    ("Growth", "+2.8%", C_ORANGE),
    ("Deps Updated", "3", C_PRIMARY),
]
...
fig.suptitle("Key Achievements \u2014 Sprint 26-03", fontsize=20, fontweight="bold", color=C_TEXT, y=0.98)
