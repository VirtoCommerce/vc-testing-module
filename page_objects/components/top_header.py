...
class TopHeader(Component):
    ...
    def currency_selector(self) -> CurrencySelector:
        return CurrencySelector(root=self._root.locator("[data-test-id='currency-selector']"))
    ...
    def ship_to_selector(self) -> ShipToSelector:
        return ShipToSelector(root=self._root.locator("[data-test-id='ship-to-selector']"))
