...
from page_objects.frontend.components.add_or_update_wishlist_modal import (
    AddOrUpdateWishlistModal,
)
from page_objects.frontend.components.delete_wishlist_modal import DeleteWishlistModal
from page_objects.frontend.components.wishlist_card import WishlistCard
