...
class BrowserStorage:
    ...
    def set_user_id(self, user_id: str) -> None:
        self._page.add_init_script(f"localStorage.setItem('{self._USER_ID_KEY}', '{user_id}')")
    ...
    def set_auth(self, token_info: TokenInfo) -> None:
        ...
        self._page.add_init_script(f"localStorage.setItem('{self._AUTH_KEY}', {json.dumps(value)})")
