...
from page_objects.components.product_configuration_area import ProductConfigurationArea
...
class ProductPage(MainLayout):
    ...
    def product_configuration_area(self) -> ProductConfigurationArea:
        return ProductConfigurationArea(
            root=self.root.locator(".product-configuration")
        )
    ...
    def add_to_cart_button(self) -> Locator:
        return self.root.locator(
            ".product-price__actions button[title='Add to cart']"
        )

    @property
    def update_cart_button(self) -> Locator:
        return self.root.locator(
            ".product-price__actions button[title='Update cart']"
        )
