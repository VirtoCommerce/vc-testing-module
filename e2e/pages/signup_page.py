...
class RegistrationPage:
    ...
    def fill_registration_form(
        self, first_name: str, last_name: str, email: str, organization_name: str, password: str, confirm_password: str
    ):
    ...
    def fill_personal_registration_form(
        self, first_name: str, last_name: str, email: str, password: str, confirm_password: str
    ):
        """Fill in the registration form with provided details"""
        self.page.locator(SignupLocators.FIRST_NAME_INPUT).type(first_name, delay=100)
        self.page.locator(SignupLocators.LAST_NAME_INPUT).type(last_name, delay=100)
