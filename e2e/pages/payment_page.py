...
class PaymentPage:
    ...
    def check_payment_page(self, payment_method: str):
        ...
        try:
            ...
            try:
                ...
                self.page.locator(PaymentPageLocators.PAYMENT_METHOD.format(payment_method)).wait_for(
                    state="visible", timeout=10000
                )
                self.page.locator(PaymentPageLocators.PAYMENT_FORM).wait_for(state="visible", timeout=10000)
                self.page.wait_for_selector(
                    CommonComponentsLocators.VC_LOADER_OVERLAY_SPINNER, state="hidden", timeout=10000
                )
    ...
    def fill_cybersource_payment_details(self, payment_info: dict):
        ...
        iframe_card_number.locator(PaymentPageLocators.CYBERSOURCE_CARD_NUMBER).type(
            payment_info["card_number"], delay=100
        )
        self.page.locator(PaymentPageLocators.CARD_HOLDER_NAME).type(payment_info["card_holder_name"], delay=100)
        self.page.locator(PaymentPageLocators.CARD_EXPIRY).type(payment_info["expiry"], delay=100)
    ...
    def skyflow_form_validation(self):
        ...
        expect(iframe.locator(PaymentPageLocators.SKYFLOW_CARD_NUMBER_ERROR)).to_contain_text(
            SKYFLOW_ERROR_MESSAGE["card_number_invalid"]
        )
        card_input.clear()
        self.page.locator(PaymentPageLocators.SKYFLOW_NEW_FORM).click()
        expect(iframe.locator(PaymentPageLocators.SKYFLOW_CARD_NUMBER_ERROR)).to_contain_text(
            SKYFLOW_ERROR_MESSAGE["card_number_required"]
        )
        ...
        self.page.locator(PaymentPageLocators.SKYFLOW_NEW_FORM).click()
        expect(iframe.locator(PaymentPageLocators.SKYFLOW_CARD_HOLDER_NAME_ERROR)).to_contain_text(
            SKYFLOW_ERROR_MESSAGE["card_holder_name_invalid"]
        )
        iframe.locator(PaymentPageLocators.SKYFLOW_CARD_HOLDER_NAME).clear()
        self.page.locator(PaymentPageLocators.SKYFLOW_NEW_FORM).click()
        expect(iframe.locator(PaymentPageLocators.SKYFLOW_CARD_HOLDER_NAME_ERROR)).to_contain_text(
            SKYFLOW_ERROR_MESSAGE["card_holder_name_required"]
        )
        ...
        self.page.locator(PaymentPageLocators.SKYFLOW_NEW_FORM).click()
        expect(iframe.locator(PaymentPageLocators.SKYFLOW_CARD_EXPIRY_ERROR)).to_contain_text(
            SKYFLOW_ERROR_MESSAGE["expiry_required"]
        )
        ...
        self.page.locator(PaymentPageLocators.SKYFLOW_NEW_FORM).click()
        expect(iframe.locator(PaymentPageLocators.SKYFLOW_CARD_EXPIRY_ERROR)).to_contain_text(
            SKYFLOW_ERROR_MESSAGE["expiry_invalid"]
        )
        ...
        self.page.locator(PaymentPageLocators.SKYFLOW_NEW_FORM).click()
        expect(iframe.locator(PaymentPageLocators.SKYFLOW_CARD_CVC_ERROR)).to_contain_text(
            SKYFLOW_ERROR_MESSAGE["cvc_invalid"]
        )
        iframe.locator(PaymentPageLocators.SKYFLOW_CARD_CVC).clear()
        self.page.locator(PaymentPageLocators.SKYFLOW_NEW_FORM).click()
        expect(iframe.locator(PaymentPageLocators.SKYFLOW_CARD_CVC_ERROR)).to_contain_text(
            SKYFLOW_ERROR_MESSAGE["cvc_required"]
        )
