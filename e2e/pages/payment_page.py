...
class PaymentPage:
    ...
    def fill_payment_details(self, payment_info: dict):
        ...
        self.page.locator(PaymentPageLocators.CARD_NUMBER).fill(payment_info["card_number"])
        self.page.locator(PaymentPageLocators.CARD_HOLDER_NAME).fill(payment_info["card_holder_name"])
        self.page.locator(PaymentPageLocators.CARD_EXPIRY).fill(payment_info["expiry"])
        self.page.locator(PaymentPageLocators.CARD_CVC).fill(payment_info["cvc"])
    ...
    def validate_card_number_field(self):
        ...
        self.page.locator(PaymentPageLocators.CARD_NUMBER).fill("5252525252525252")
        self.clear_field("card_number")
        self.page.locator(PaymentPageLocators.CARD_HOLDER_NAME).fill("John Doe")
        self.page.locator(PaymentPageLocators.CARD_EXPIRY).fill("01/30")
        self.page.locator(PaymentPageLocators.CARD_CVC).fill("900")
    ...
    def validate_card_holder_name_field(self):
        ...
        self.page.locator(PaymentPageLocators.CARD_NUMBER).fill("4111111111111111")
        self.page.locator(PaymentPageLocators.CARD_HOLDER_NAME).fill("ryr")
        self.clear_field("card_holder_name")
        self.page.locator(PaymentPageLocators.CARD_EXPIRY).fill("01/30")
        self.page.locator(PaymentPageLocators.CARD_CVC).fill("123")
        # Click away from the field to trigger validation
        self.page.locator(PaymentPageLocators.CARD_NUMBER).click()
        self.expect_validation_message("This field is required")
        expect(self.page.locator(PaymentPageLocators.PAY_NOW_BUTTON)).to_be_disabled()        
        # Test with more than 64 characters
        self.clear_field("card_holder_name")
        long_name = "A" * 65  # Create a string with 65 characters
        self.page.locator(PaymentPageLocators.CARD_HOLDER_NAME).fill(long_name)
        self.page.locator(PaymentPageLocators.CARD_NUMBER).click()
    ...
    def validate_expiry_field(self):
        ...
        self.page.locator(PaymentPageLocators.CARD_NUMBER).fill("4111111111111111")
        self.page.locator(PaymentPageLocators.CARD_HOLDER_NAME).fill("John Doe")
        self.page.locator(PaymentPageLocators.CARD_EXPIRY).fill("")
        self.page.locator(PaymentPageLocators.CARD_CVC).fill("123")
        # Click away from the field to trigger validation
        self.page.locator(PaymentPageLocators.CARD_HOLDER_NAME).click()
        self.expect_validation_message("This field is required")       
        expect(self.page.locator(PaymentPageLocators.PAY_NOW_BUTTON)).to_be_disabled() 
        self.page.locator(PaymentPageLocators.CARD_EXPIRY).fill("1")        
        self.page.locator(PaymentPageLocators.CARD_HOLDER_NAME).click()
        self.expect_validation_message("Month must be exactly 2 characters")
        expect(self.page.locator(PaymentPageLocators.PAY_NOW_BUTTON)).to_be_disabled()
        self.clear_field("expiry")
        self.page.locator(PaymentPageLocators.CARD_EXPIRY).fill("33")        
        self.page.locator(PaymentPageLocators.CARD_HOLDER_NAME).click()
        self.expect_validation_message("Please provide a valid expiration month")
        expect(self.page.locator(PaymentPageLocators.PAY_NOW_BUTTON)).to_be_disabled()
        self.clear_field("expiry")
        self.page.locator(PaymentPageLocators.CARD_EXPIRY).fill("01/2")
        self.page.locator(PaymentPageLocators.CARD_HOLDER_NAME).click()
        ...
        self.page.locator(PaymentPageLocators.CARD_HOLDER_NAME).fill("John Doe")     
        self.page.locator(PaymentPageLocators.CARD_CVC).fill("123")
        self.page.locator(PaymentPageLocators.CARD_EXPIRY).fill("03/03")
        self.page.locator(PaymentPageLocators.PAY_NOW_BUTTON).click()
    ...
    def validate_cvc_field(self):
        ...
        self.page.locator(PaymentPageLocators.CARD_NUMBER).fill("4111111111111111")
        self.page.locator(PaymentPageLocators.CARD_HOLDER_NAME).fill("John Doe")
        self.page.locator(PaymentPageLocators.CARD_EXPIRY).fill("01/29")
        self.page.locator(PaymentPageLocators.CARD_CVC).fill("")
        # Click away from the field to trigger validation
        self.page.locator(PaymentPageLocators.CARD_EXPIRY).click()
        self.expect_validation_message("This field is required")
        self.clear_field("cvc")
        self.page.locator(PaymentPageLocators.CARD_CVC).fill("1")
        self.page.locator(PaymentPageLocators.CARD_EXPIRY).click()
    ...
    def validate_card_number_format(self):
        ...
        self.page.locator(PaymentPageLocators.CARD_HOLDER_NAME).fill("John Doe")     
        self.page.locator(PaymentPageLocators.CARD_CVC).fill("123")
        self.page.locator(PaymentPageLocators.CARD_EXPIRY).fill("02/29")
        self.page.locator(PaymentPageLocators.CARD_NUMBER).fill("4111")        
